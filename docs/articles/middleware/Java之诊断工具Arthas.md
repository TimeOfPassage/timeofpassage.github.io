...
![](../../_media/image/2020108_arthas_main.jpg)
如上图可知：
> Main类：demo.MathGame

### Q: 如何反编译已知类?
### A: 通过`jad`命令查看,`jad+全限定名`反编译指定类源码
![](../../_media/image/2020108_arthas_jad.jpg)
...
![JPDA](https://developer.ibm.com/developer/default/articles/j-lo-jpda1/images/jdwp.jpg)
